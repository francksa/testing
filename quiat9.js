	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Coke', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'Pepsi', //Will appear in the data and in the default feedback message.
				title : {
			...
			base_url : {//Where are your images at?
				image : 'https://francksa.github.io/testing/quiat9.js'
			},
